...
import { dedupeAddressSegments } from "@/lib/clinic-onboarding";
      ...
      {clinics.map((clinic, index) => (
        <li key={clinic.id}>
          ...
          >
            ...
            <p className="mt-3 text-xs font-semibold uppercase tracking-[0.14em] text-primary/80">
              {clinic.city || "India"}
